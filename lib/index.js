...
(function() {
  ...
  GamaSign = {
    ...
    verifyMethod: function(httpMethod) {
      return (httpMethod != null) && _.isString(httpMethod) && _.indexOf(HTTP_METHODS, httpMethod.toUpperCase()) !== -1;
    },
    makeSign: function(httpMethod, baseUri, params, ignoreParams, accessKeyId, accessKeySecret) {
      var sign;
      params = params || {};
      ignoreParams = ignoreParams || {};
      sign = oauthSign.hmacsign(httpMethod, baseUri, this.removeIgnoreParams(params, ignoreParams), accessKeyId, accessKeySecret);
      return sign;
    },
